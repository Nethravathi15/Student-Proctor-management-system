								...
								<div class="row">
                                   ...
                                   <div class="col-lg-6 col-md-4" style="margin-top:10px;">
									...
									<div class="col-lg-12 col-md-4" style="margin-top:10px;">
                                        ...
                                        <input required="required" type="text" class="form-control" id="ExtraCurricilarAchievements"  name="ExtraCurricilarAchievements" placeholder="Your answer" value="<?php echo $ExtraCurricilarAchievements; ?>">
                                    </div>
