      ...
      <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h3 lead">Student Marks</h1>
          </div>
          <?php
            ...
            <div class="table-responsive">
                        <table class="table table-striped table-hover table-bordered shadow-sm align-middle">
                            ...
                            <tbody>
                                ...
                                $query = "select proctoring_student.proctoring_student_usn,proctoring_marks.* from proctoring_marks,proctoring_student where email='$email' and proctoring_student_email=email and proctoring_student_email='$email'";
