...
$Class10School=$_GET['Class10School'];
$Class12College=$_GET['Class12College'];
$DegreeCollege=$_GET['DegreeCollege'];


        $query = "insert into proctoring_studentdetails values('','$name','$dob','$phone','$email','$USN','$Address','$pAddress','$Father','$foccupation','$fnum','$Mother','$moccupation','$mnum','$lgname','$loccupation','$lnum','$Accommodation','$MOA','$Rank','$KMAT','$Class10','$Class10Board','$Class10per','$Class10cgpa','$Class12','$Class12Board','$Class12per','$Class12cgpa','$DegreeSpecilization','$yop','$dboard','$degmarks','$degcgpa','$Scholarship','$Achievements','$ExtraCurricilarAchievements','$Health','$other','$Class10School','$Class12College','$DegreeCollege')";
		echo $query;
