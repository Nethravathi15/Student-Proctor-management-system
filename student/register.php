    ...
    <div class="min-vh-100 d-flex flex-column bg-image">
        ...
        <div class="card text-center col-11 col-sm-6 m-auto shadow py-4 border-warning">
            ...
            <div class="card-body my-3">
                <h5 class="card-title text-uppercase lead mb-4 pb-1">Faculty Login</h5>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-10 col-12">
                                <div class="d-grid mt-3 mb-1">
                                    <button class="btn text-white" style="background: #FF970A;" type="submit" onclick="return Validate()" >Login</button>
                                </div>
                            </div>
                        </div>
                    </div>
