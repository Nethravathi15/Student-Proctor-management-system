      ...
      <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h3 lead">Search Student</h1>
          </div>
          <?php
          ...
          <form id="form" name="form" class="text-center" method="POST">
            <h4 class="h4 text-center mb-4">Attendance</h4>

            <div class="row justify-content-evenly">
              <div class="mb-3 col-md-4">
                <label class="form-label">Enter USN :</label>
				<input type="date" id="date" name="date" class="form-select shadow-none" />
              </div>
              <div class="mb-3 col-md-4">
            ...
            <div class="row justify-content-evenly mt-5">
              <div class="mb-3 col-md-4">
                <input type="submit" class="btn w-100 text-light" value="Fetch Attendance Data" name="butsave" id="butsave"  style="background: #FF970A;" />
              </div>
            </div>
            ...
            <div class="table-responsive" id="atttab">
                        <table class="table table-striped table-hover table-bordered shadow-sm align-middle">
                            ...
                            <tbody>
                                ...
                                $query = "select * from attend_2021_attendance where dated='".$_POST['date']."' and subject='".$_POST['subject']."'";
								//echo $query;
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                    ...
                                    echo '<td>' . $row['usn'] . '</td>';
                                    echo '<td id="usn" name="usn">' . $row['dated'] . '</td>';
                                    echo '<td id="usn" name="usn">' . $row['stat'] . '</td>';
                                    echo '</tr>';
                                }
                                ?>
                            </tbody>
