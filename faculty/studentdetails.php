                            ...
                            <div class="card-body" style="color: skyblue;">
								...
								<div class="row">
								    <div class="col-lg-6 col-md-4" style="margin-top:10px;">
                                        ...
                                        <input required="required" type="text" class="form-control" id="name" value="<?php echo $name; ?>"  name="name" placeholder="Your answer">
                                    </div>
                                   ...
                                   <div class="col-lg-6 col-md-4" style="margin-top:10px;">
									 ...
									 <div class="col-lg-6 col-md-4" style="margin-top:10px;">
                                        ...
                                        <input required="required" type="email" class="form-control" id="email" name="email" value="<?php echo $email; ?>" placeholder="Your answer">
                                    </div>
