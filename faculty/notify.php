      ...
      <div class="row">
        <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
          <div class="position-sticky pt-3">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link faculty" aria-current="page" href="notify.php" style="background: #FF970A;">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h3 lead">Notification</h1>
          </div>
          <?php
          if (isset($_SESSION["mailsend"])) {
            if ($_SESSION["mailsend"] == "success") {
          ?>
              <div class="alert alert-success alert-dismissible fade show mt-2" role="alert">
                <strong>Mail Sending Successfully!</strong>
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
              </div>
            <?php
            } else if ($_SESSION["mailsend"] == "failed") {
            ?>
            <?php
            }
            ?>
          ...
          <form id="form" name="form" action="sendnotification.php" class="text-center">
            <h4 class="h4 text-center mb-4">Notification Creation</h4>
			...
			-->
            <div class="row justify-content-evenly">
              <div class="mb-8 col-md-10">
                <label class="form-label">Notification :</label>
                <textarea type="text" class="form-control shadow-none" name="notify" id="notify" placeholder="Content" rows="3" required="required"></textarea>
              </div>
            </div>

            <div class="row justify-content-evenly mt-5">
              <div class="mb-3 col-md-4">
                <input type="submit" onclick="return Validator();" class="btn w-100 text-light" value="Send Email" name="butsave" id="butsave"  style="background: #FF970A;" />
              </div>
            </div>
 <script>
     function Validator() {
